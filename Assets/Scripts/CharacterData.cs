...
public class CharacterData : ScriptableObject
{
   ...
   [SerializeField] [Range(0.75f, 1.25f)] private float kneeSize = 1f;
   [SerializeField] [Range(0.9f, 1.1f)] private float chestSize = 1f;
   [SerializeField] [Range(0.8f, 1.4f)] private float neckize = 1f;
   ...
   public  Vector3 GetNeckSize => new Vector3(neckize, neckize, neckize);
